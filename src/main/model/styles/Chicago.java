 ...
 */
public class Chicago extends Citation implements Serializable {

    // EFFECTS: creates an Chicago citation object with only a Paper ID
    public Chicago(String id) {
        super(id);
    }
    ...
    protected String getOutput() {
        return "Chicago: " + this.getAuthor() + ", " + this.getTitle() + ".";
    }
